...
getJson("resdata.json",function(text){
...
var properties = ["S.No", "Name of the Institute", "Qualification", "Year","Aggregate"]; 
var tr = document.createElement('tr');
...
var property= ["no", "clg", "quli", "yop","Aggregate"];
for (var r = 0; r <3; r++) {
  var tr = document.createElement('tr');
